...
namespace LhDev.DemoOne.Middleware;
...
public class ExceptionMiddleware(RequestDelegate next)
{
    ...
    private static async Task HandleApiExceptionAsync(HttpContext context, DemoOneWebException ex)
    {
